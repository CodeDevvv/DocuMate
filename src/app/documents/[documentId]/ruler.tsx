...
export const Ruler = () => {
        ...
        if (isDraggingLeft || isDraggingRight && rulerRef.current) {
            ...
            if (container) {
                ...
                if (isDraggingLeft) {
                    ...
                    setLeftMargin(newLeftPosition); // TODO: Make collabarative
                }
    ...
    return (
        <div
            ...
            className="w-[816px] mx-auto h-6 border-b border-gray-300 flex item-end relative select-none print:hidden">
            <div
                id="ruler-container"
